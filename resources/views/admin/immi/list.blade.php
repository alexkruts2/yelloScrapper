...
@section('content')
    <div class="row page-titles">
        <div class="col-md-12">
            <h4 class="text-white">移民列表</h4>
        </div>
        <div class="col-md-6">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="/admin">首页</a></li>
                <li class="breadcrumb-item active">移民列表</li>
            </ol>
        </div>
    </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="tbl_immigrant" class="display nowrap table table-striped table-bordered">
                            <thead>
                            <tr>
                                ...
                                <th class="text-center">下签/办理周期</th>
